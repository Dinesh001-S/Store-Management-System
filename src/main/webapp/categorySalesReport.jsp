...
<head>
    ...
    <script>
	    function showProducts(customerId, filterType, startDate, endDate) {
		    window.location.href = 'categorySpecificBills.jsp?categoryId=' + customerId+'&filterType='+filterType+'&sDate='+startDate+'&eDate='+endDate;
		}
...
<body>
    ...
    <form method="GET" action="CategorySalesServlet">
    ...
    <div class="header-row">
	    <form id="limitChangeForm" action="CategorySalesServlet" method="get">
    ...
    <table>
        ...
        <tbody>
            <%
                ...
                List<CategorySales> customerSalesList = (List<CategorySales>) request.getAttribute("categoryBillsCount");
                CategoryDao categoryDao = new CategoryDao();
                if (customerSalesList != null && !customerSalesList.isEmpty()) {
                    for (CategorySales sales : customerSalesList) {
            %>
                        <tr onclick="showProducts('<%= sales.getCategoryID() %>', '<%= filterType %>', '<%= specificDate %>', '<%= toDate %>')">
                            <td><%= sales.getCategoryID() %></td>
                            <td><%= categoryDao.getCategoryName(sales.getCategoryID()) %></td>
